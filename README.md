...
It will also set the icon [color](https://www.scaler.com/topics/css/css-color/) to the value found in the CSS variable `--card-mod-icon-color` if present. This ignores entity state, but will still dim.
